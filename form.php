...
if(isset($_POST['submit'])){
    ...
    $url="http://securework.co/create_api/manage_form.php?token=ahdhsasdnasbwdldkgldk&id=".$id;
    $ch=curl_init();
...
if(isset($_GET['id']) && $_GET['id']>0){
    $url="http://securework.co/create_api/index.php?token=ahdhsasdnasbwdldkgldk&id=".$_GET['id'];
    $ch=curl_init();
    curl_setopt($ch, CURLOPT_URL,$url);
    curl_setopt($ch,CURLOPT_RETURNTRANSFER,true);
    $result=curl_exec($ch);
